...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VetoedSong.title'
        db.add_column('party_vetoedsong', 'title',
                      self.gf('django.db.models.fields.CharField')(default='Justin Bieber - ALL his songs', max_length=1024),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VetoedSong.title'
        db.delete_column('party_vetoedsong', 'title')
    ...
    models = {
        ...
        'party.vetoedsong': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'party': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['party.PartyPlaylist']"}),
            'title': ('django.db.models.fields.CharField', [], {'default': "'Justin Bieber - ALL his songs'", 'max_length': '1024'})
        }
    }
