...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VetoedSong'
        db.create_table('party_vetoedsong', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('party', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['party.PartyPlaylist'])),
            ('deezer_id', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('party', ['VetoedSong'])


    def backwards(self, orm):
        # Deleting model 'VetoedSong'
        db.delete_table('party_vetoedsong')
    ...
    models = {
        ...
        'party.vetoedsong': {
            ...
            'deezer_id': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'party': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['party.PartyPlaylist']"})
        }
    }
