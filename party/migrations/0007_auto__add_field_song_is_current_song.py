...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Song.is_current_song'
        db.add_column('party_song', 'is_current_song',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Song.is_current_song'
        db.delete_column('party_song', 'is_current_song')
